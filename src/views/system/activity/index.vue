    ...
    <el-table v-loading="loading" :data="activityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="管理" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          ...
          <el-button link type="primary" @click="handleRoute('/activity/recordView/'+scope.row.id)"
          >签到管理
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="activityRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="图片预览">
          <el-image v-if="form.imgs" style="height: 120px" :src="baseAPI+form.imgs"></el-image>
          <div v-else>暂无预览</div>
        </el-form-item>
        ...
        <el-form-item label="活动描述" prop="describe">
          <editor v-model="form.describe" min="0" step="1" step-strictly :min-height="192"/>
        </el-form-item>
      </el-form>
      <template #footer>
