  ...
  <div class="app-container">
    ...
    <el-table class="mt20" :data="voluList">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" v-hasRole="['admin','admin2','organizationadmin']" @click="handleUpdate(scope.row)">审核
          </el-button>
          <el-button link type="primary" v-hasRole="['admin','admin2','organizationadmin']" @click="handleDelete(scope.row)">删除
          </el-button>
        </template>
      </el-table-column>
    </el-table>
...
import {delRelation, listRelation, updateRelation} from "@/api/system/volunteerActivityRelation.js";
